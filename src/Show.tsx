...
function Navbar() {
    ...
    const faClick = (event: React.MouseEvent<HTMLElement>): void => {
        faIconClassName === "NavBar"
            ? setClassName("NavBar")
            : setClassName("SlideNavBar")
    }

    return (
        <div className="NavBarDiv">
            <i className="fa fa-bars" onClick={faClick}></i>
            <h1 className="Title">Rubicon</h1>
...
function SearchInput(props: { searchInput: string; handleChange: any }) {
    return (
        <div className="InputDiv">
            <img src={searchIMG} className="SearchIMG" alt="" />
            <input
                type="text"
                spellCheck="false"
                placeholder="Search"
